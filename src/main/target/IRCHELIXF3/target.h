...
#define TARGET_BOARD_IDENTIFIER "IHF3"
...
#define DEFAULT_FEATURES        (FEATURE_BLACKBOX | FEATURE_SDCARD | FEATURE_CURRENT_METER | FEATURE_VBAT | FEATURE_TELEMETRY | FEATURE_LED_STRIP)
